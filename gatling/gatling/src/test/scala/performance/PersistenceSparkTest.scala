...
// class PersistenceSparkTest extends Simulation {
...
//   private val scn = scenario("PersistenceApiTest")
//     .exec(
//       http("ping")
...
// setUp(scn.inject(rampUsersPerSec(10).to(1200).during(120 seconds))).protocols(httpProtocol)
// }
